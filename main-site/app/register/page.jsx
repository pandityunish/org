      ...
      <div className="grid py-2 mx-auto md:grid-cols-2 max-w-9xl">
        <div className="flex items-center justify-start px-4 py-10 bg-white md:px-0 sm:py-16 lg:py-24 ">
          <div className="xl:w-full xl:max-w-sm 2xl:max-w-md ">
            <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl">Signup to Epass</h2>
            <p className="mt-2 text-base text-gray-600">Already have an account?
              <Link href="/login" title className="px-2 font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 hover:underline focus:text-blue-700" >Login now </Link>
        ...
        <div className="flex items-center justify-end px-4 py-10 sm:py-16 lg:py-24 bg-sky-50 ">
          <div>
            <img width="{500}" height="{500}" layout="responsive" objectfit="contain" objectposition="center" className="w-full mx-auto" src="/qr-scanning.svg" alt />
            <div className="w-full mx-auto xl:max-w-xl">
              <h3 className="text-2xl font-bold text-center text-black">Get Your Own QR</h3>
